...
resource "azuredevops_pipeline_authorization" "pipeline_environment" {
...
resource "azuredevops_pipeline_authorization" "pipeline_service_connection" {
...
resource "azuredevops_pipeline_authorization" "pipeline_agent_pool" {
  for_each    = local.pipelines
  project_id  = local.project_id
